 ...
 * callable object and its optional arguments as a normal, delayed or repeated
 * task.
 *
 * GenericWorker executes tasks one after one, in the FIFO way, while tasks are
 * non-preemptible.
 *
 * Please NOTE that, as the name indicates, this a worker thread for the general
